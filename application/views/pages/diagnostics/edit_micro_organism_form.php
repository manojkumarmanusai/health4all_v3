      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input type="text" class="form-control" placeholder="Micro Organism" id="micro_organism" name="micro_organism" 
            value="<?php echo isset($micro_organisms[0]->micro_organism) ? $micro_organisms[0]->micro_organism : ''; ?>" 
          />
          <?php if(isset($micro_organisms[0])) { ?>
  ...
  <div class="col-md-12">
    <?php echo form_open('diagnostics/edit/micro_organism', array('role' => 'form', 'id' => 'micro_organism_form', 'class' => 'form-inline', 'name' => 'micro_organism')); ?>
      ...
      <table class="table-bordered col-md-12">
        <tbody>
          <tr>
            <td><input type="text" class="form-control" placeholder="Micro Organism" id="micro_organism" name="micro_organism"></td>
      ...
      <table class="table-hover table-bordered col-md-10">
        ...
        <tbody>
          ...
          foreach($micro_organisms as $tg){ ?>
            <tr onclick="$('#micro_organism_form_<?php echo $tg->micro_organism_id; ?>').submit();" style="cursor: pointer;">
              <td><?php echo $j++; ?></td>
              <td>
                <?php echo $tg->micro_organism; ?>
