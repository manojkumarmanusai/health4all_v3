      	...
      	<div class="row">							
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
				<div class="form-horizontal">
					...
					<input type="text" class="form-control" id="smsModal-customer" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="Enter '0' followed by 10 digit phone number" value='<?php echo $registered->phone;?>' required" />
